/* https://www.cyberforum.ru/javascript-api/thread2314663.html
Google API Простой интернет магазин на гугл табличках. Пример реализации
24.08.2018, 21:13. Просмотров 494. Ответов 9
Метки cms, free, google (Все метки)
Сделал демку интернет магазина, который все свои данные берет из этой гугл таблички https://docs.google.com/spreadsheets...i6EbhOcps9u-Y/ заказы отправляются формой в отдельную табличку https://docs.google.com/spreadsheets...M44ynLLf9aScw/ , а эта табличка отправляет почту в магазин и заказчику. Магазин представляет из себя одну единственную статичную html страничку, которую может сохранить себе любой желающий и прикрепить свою табличку в коде http://heeg.ru/shop_test21.html#%24%3A%2Fboot%2Fboot.js В магазине 12695 товаров и 286 разделов.

Вот сама демка магазина http://heeg.ru/shop_test21.html

Прошу потестить скорость работы базы данных на гугл табличках. И вообще оценить идею использования гугл табличек в качестве замены SQL базы данных. Если кто-то видел подобные идеи, тоже напишите. Планирую эту тему развивать дальше.
*/
/*\
title: $:/boot/boot.js
...
\*/
 var part='';
var search_text='';
var dataURL = 'https://docs.google.com/spreadsheets/d/1ExMxzgAWUjle1YmeN5emOHgg7sEv8Wi6EbhOcps9u-Y/gviz/tq?sheet=goods';
...
search_text=$tw.wiki.renderTiddler("text/plain","$:/constant/_searchfield");
if(search_text.length>2){
$tw.notifier.display("$:/_issearching");
    querySummary = "select * Where LOWER(C) like lower('%"+search_text+"%') " ;
    drawVisualization(dataURL,querySummary);
}else{alert("для поиска необходимо ввести не менее 3-ех символов")};
}
...
//google.setOnLoadCallback(summaryVisual);

//_______________________________конец кода Google API___________________
